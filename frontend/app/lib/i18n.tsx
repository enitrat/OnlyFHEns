...
const translations: Record<Language, TranslationDict> = {
	en: {
		...
		mint: {
			heroBadge: "Dev Tools",
			heroTitle: "Mint Test Tokens",
			heroSubtitle: "Get confidential tokens for testing and development",
			title: "Mint confidential tokens",
			description: "Click below to mint 1000 test tokens to your wallet",
			fields: {
				token: "Token address",
				amount: "Amount ",
			},
			...
			button: "Mint 1000 Tokens",
			loading: {
				submitting: "Submitting mint transaction...",
				submitted: "Mint transaction submitted",
			},
			status: {
				pending: "Minting… confirm in wallet.",
				success: "Tokens minted successfully!",
				successWithAmount: "{amount} tokens minted successfully!",
				error: "Mint failed.",
			},
			noteSepolia:
				"⚠️ On Sepolia testnet, minting may be restricted depending on the deployed token contract.",
			tx: {
				label: "Transaction: ",
				link: "View on explorer",
			},
	...
	fr: {
		...
		mint: {
			heroBadge: "Outils de développement",
			heroTitle: "Minter des jetons de test",
			heroSubtitle:
				"Obtenez des jetons confidentiels pour tester et développer",
			title: "Obtenir des jetons confidentiels",
			description:
				"Cliquez ci-dessous pour minter 1000 jetons de test sur votre wallet",
			fields: {
			...
			button: "Minter 1000 jetons",
			loading: {
				submitting: "Envoi de la transaction de mint...",
				submitted: "Transaction de mint envoyée",
			},
			status: {
				pending: "Mint en cours… confirmez dans votre wallet.",
				success: "Jetons mintés avec succès !",
				successWithAmount: "{amount} jetons mintés avec succès !",
				error: "Échec du mint.",
			},
			noteSepolia:
				"⚠️ Sur le testnet Sepolia, le mint peut être restreint selon le contrat déployé.",
			tx: {
				label: "Tx : ",
				link: "Voir sur l'explorateur",
			},
